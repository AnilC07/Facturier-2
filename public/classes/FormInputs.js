...
export class FormInput {
    ...
    getStoreDocsListener() {
        this.btnStoredInvoices.addEventListener("click", this.getItems.bind(this, 'invoices'));
        this.btnStoredEstimates.addEventListener("click", this.getItems.bind(this, 'estimates'));
    }
    getItems(docType) {
        console.log(this.storedEl.hasChildNodes());
